...
```bash
git clone https://github.com/actionanand/vault-nest.git --branch 1-skeleton new-proj-name
```

```bash
npx degit github:actionanand/vault-nest#1-skeleton new-proj-name
```

```bash
npx gitpick https://github.com/actionanand/vault-nest -b 1-skeleton
```
